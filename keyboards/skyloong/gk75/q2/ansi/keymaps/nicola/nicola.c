...
#define SS_ALNUM(x) SS_TAP(X_CAPS_LOCK) x SS_TAP(X_CAPS_LOCK) // X_CAPSLOCK
...
void nicola_m_type(void) {
    ...
    if (n_modifier == 0) {
        switch(nicola_m_key) {
            ...
            case NG_MINS: send_string(SS_TAP(X_PMNS)); break;
            ...
            case NG_BSLS: send_string(SS_TAP(X_INT3)); break;//
...
void nicola_om_type(void) {
    if(nicola_o_key == NG_SHFTL) {
        switch(nicola_m_key) {
            ...
            case NG_3   : send_string(SS_LSFT(SS_TAP(X_EQUAL))); break;      // ～
            ...
            case NG_LBRC: send_string(SS_LSFT("]")); break;
            case NG_RBRC: send_string(SS_TAP(X_NUHS)); break;
            case NG_BSLS: send_string(SS_TAP(X_INT1)); break;
        ...
        switch(nicola_m_key) {
            case NG_1   : send_string("?"); break;      // ？
            case NG_2   : send_string(SS_ALNUM(SS_TAP(X_SLASH))); break;//
            case NG_3   : send_string(SS_LSFT(SS_TAP(X_EQUAL))); break; // ~ send_string(SS_ALNUM(SS_LSFT(SS_TAP(X_EQUAL))))
            case NG_4   : send_string("]" ); break; // [
            case NG_5   : send_string(SS_TAP(X_NUHS)); break; // ]
            case NG_6   : send_string(SS_LSFT("]" )); break; // {
            case NG_7   : send_string(SS_LSFT(SS_TAP(X_NUHS))); break; // }
            ...
            case NG_LBRC: send_string("[" ); break;
            case NG_RBRC: send_string("'" ); break;
            case NG_BSLS: send_string(SS_ALNUM(SS_TAP(X_INT3))); break;//
